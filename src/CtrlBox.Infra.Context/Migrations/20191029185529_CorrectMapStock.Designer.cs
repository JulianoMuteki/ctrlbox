...
namespace CtrlBox.Infra.Context.Migrations
{
    ...
    [Migration("20191029185529_CorrectMapStock")]
    partial class CorrectMapStock
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CtrlBox.Domain.Entities.DeliveryBox", b =>
                {
                    ...
                    b.HasKey("DeliveryDetailID", "BoxID");
            ...
            modelBuilder.Entity("CtrlBox.Domain.Entities.DeliveryDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("QuantityProductItem");

                    b.HasKey("Id")
                        .HasName("DeliveryDetailID");
            ...
            modelBuilder.Entity("CtrlBox.Domain.Entities.GraphicCodes", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("GraphicCodeID");
                    ...
                    b.HasKey("Id")
                        .HasName("GraphicCodeID");

                    b.ToTable("GraphicsCodes");
                });
            ...
            modelBuilder.Entity("CtrlBox.Domain.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CtrlBox.Domain.Entities.TrackingClient", b =>
                {
                    ...
                    b.HasKey("ClientID", "TrackingID");

                    b.HasIndex("TrackingID");

                    b.ToTable("TrackingsClients");
                });
            ...
            modelBuilder.Entity("CtrlBox.Domain.Entities.Box", b =>
                {
                    ...
                    b.HasOne("CtrlBox.Domain.Entities.GraphicCodes", "GraphicCodes")
                        .WithMany("Boxes")
                        .HasForeignKey("GraphicCodeID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.OwnsOne("CtrlBox.Domain.Entities.FlowStep", "FlowStep", b1 =>
                        {
                            ...
                            b1.HasOne("CtrlBox.Domain.Entities.Box")
                                .WithOne("FlowStep")
                                .HasForeignKey("CtrlBox.Domain.Entities.FlowStep", "BoxId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
            ...
            modelBuilder.Entity("CtrlBox.Domain.Entities.DeliveryBox", b =>
                {
                    ...
                    b.HasOne("CtrlBox.Domain.Entities.DeliveryDetail", "DeliveryDetail")
                        .WithMany("DeliveriesBoxes")
                    ...
                    b.OwnsOne("CtrlBox.Domain.Entities.FlowStep", "FlowStep", b1 =>
                        {
                            ...
                            b1.HasOne("CtrlBox.Domain.Entities.ProductItem")
                                .WithOne("FlowStep")
                                .HasForeignKey("CtrlBox.Domain.Entities.FlowStep", "ProductItemId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
