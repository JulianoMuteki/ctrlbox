var FormComponents = function () {
    ...
    var handleInputMasks = function () {
        ...
        $("#mask_currency").inputmask('R$ 999.999,99', { numericInput: true });  //123456  =>  € ___.__1.234,56
        $("#mask_currencyX").inputmask('R$ 999.999,99', { numericInput: true, rightAlignNumerics: false, greedy: false }); //123456  =>  € ___.__1.234,56
        $("#mask_currencyY").inputmask('R$ 999.999,99', { numericInput: true, rightAlignNumerics: false, greedy: false }); //123456  =>  € ___.__1.234,56

        $("#mask_currency2").inputmask('R$ 999,999,999.99', { numericInput: true, rightAlignNumerics: false, greedy: false}); //123456  =>  € ___.__1.234,56
