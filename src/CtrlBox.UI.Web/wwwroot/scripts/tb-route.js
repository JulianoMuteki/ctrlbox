    ...
    return {
        ...
        init: function (url) {
            function restoreRow(oTable, nRow) {
                ...
                oTable.fnUpdate(aData.KmDistance, nRow, 1, false);
                oTable.fnUpdate(aData.Truck, nRow, 2, false);
                oTable.fnUpdate(getElementEdit(), nRow, 4, false);
                oTable.fnUpdate(getElementDelete(), nRow, 5, false);
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[1].innerHTML = '<input type="text" class="m-wrap small" value="' + aData.KmDistance + '">';
                jqTds[2].innerHTML = '<input type="text" class="m-wrap small" value="' + aData.Truck + '">';
            ...
            function saveRow(oTable, nRow) {
                ...
                data.KmDistance = jqInputs[1].value;
                data.Truck = jqInputs[2].value;
            ...
            function getElementRelation(id) {
                ...
                return '<a href="' + url + '" class="btn mini"><i class="icon-link"></i> Relation destination clients</a>';
            }
